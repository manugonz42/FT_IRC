...
{
		::sendMessage(PREFIX, client->getFd(), "001 " + client->getField("NICK") + " :" +
		...
		::sendMessage(PREFIX, client->getFd(), "002 " + client->getField("NICK") + " :" +
		...
		::sendMessage(PREFIX, client->getFd(), "003 " + client->getField("NICK") + " :" +
